...
public class AddSpraywallToBoulderGymCommandHandler : ICommandHandler<AddSpraywallToBoulderGymCommand>
{
    private readonly IBiBaBoulderDbContext _dbContext;
    private readonly ICurrentUserService _currentUserService;

    public AddSpraywallToBoulderGymCommandHandler(
    ...
    public async Task HandleAsync(AddSpraywallToBoulderGymCommand command)
    {
