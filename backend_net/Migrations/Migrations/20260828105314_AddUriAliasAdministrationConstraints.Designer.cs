...
namespace BiBaBoulder.Migrations
{
    ...
    [Migration("20260828105314_AddUriAliasAdministrationConstraints")]
    partial class AddUriAliasAdministrationConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thecell.Bibaboulder.Model.Model.Media.UriAlias", b =>
                {
                    ...
                    b.HasIndex("OutdoorAreaId");

                    b.HasIndex("Type", "Alias")
                        .IsUnique();

                    b.ToTable("UriAliases", t =>
                        {
                            t.HasCheckConstraint("CK_UriAlias_OnlyOneForeignKey", "([BoulderGymId] IS NOT NULL AND [OutdoorAreaId] IS NULL) OR ([BoulderGymId] IS NULL AND [OutdoorAreaId] IS NOT NULL)");
                        });
                });
                    ...
                    b.OwnsMany("Thecell.Bibaboulder.Model.Model.Outdoor.PublicResource", "Media", b1 =>
                        {
                            ...
                            b1.HasKey("BoulderGymId", "Uri", "ResourceType");

                            b1.ToTable("BoulderGymImages", (string)null);
            ...
            modelBuilder.Entity("Thecell.Bibaboulder.Model.Model.Indoor.BoulderLog", b =>
                {
                    b.HasOne("Thecell.Bibaboulder.Model.Model.Indoor.SpraywallProblem", "SpraywallProblem")
            ...
            modelBuilder.Entity("Thecell.Bibaboulder.Model.Model.Indoor.SpraywallProblem", b =>
                {
                    ...
                    b.HasOne("Thecell.Bibaboulder.Model.Model.Indoor.Spraywall", "Spraywall")
                        .WithMany("SpraywallProblems")
            ...
            modelBuilder.Entity("Thecell.Bibaboulder.Model.Model.LogEntry", b =>
                {
                    b.HasOne("Thecell.Bibaboulder.Model.Model.Indoor.BoulderLog", "BoulderLog")
                        .WithMany("LogEntries")
