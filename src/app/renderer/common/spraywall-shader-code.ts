...
export const beginVertex = ['#include <begin_vertex>', 'vUv1 = vec3( uv1, 1 ).xy;'];
...
export const mapFragment = [
  ...
  'vec3 grayScale = vec3((sampledDiffuseColor.r * 0.2126 + sampledDiffuseColor.g * 0.7152 + sampledDiffuseColor.b * 0.0722));',
